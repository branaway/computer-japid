...
To run the sample, make sure you're using play 2.2.0 or later.
...
object ApplicationBuild extends Build {
    ...
    val appDependencies = Seq(
      ...
      "japid42" % "japid42_2.10" % "0.9.10" // use 0.9.9.1 for Play 2.1.x
    )
...
public class Global extends cn.bran.play.GlobalSettingsWithJapid {
	...
	public void onStartJapid() {
	    setTemplateRoot("japidroot", "modules/foo/japidroot"); // the module's japid root also must be specified if you have one
		setLogVerbose(true);
...
2013.5.30
# made to use japid42 version 0.9.3
2013.6.13
# using japid 0.9.4.1
