...
"    ");// line 26
		p("    ");// line 28
		p(routes.Application.list(newPage, sortBy, order, currentFilter));// line 29
		p("    \n");// line 29
...
// line 37
		...
		p(" header  ");// line 38
		if(currentSortBy.equals(key)){// line 38
		p(" ");// line 38
		p(currentOrder.equals("asc") ? "headerSortDown" : "headerSortUp");// line 38
		p(" ");// line 38
		}// line 38
		p("\">\n" + 
"        <a href=\"");// line 38
		p(link(0, key));// line 39
		p("\">");// line 39
		p(title);// line 39
		p("</a>\n" + 
"    </th>\n");// line 39
